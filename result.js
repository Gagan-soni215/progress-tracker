...
//     let originalWeakSubjects = [...weakSubjects];
...
//         if (weakSubjects.length > 0 && !facultyQuestionAsked) askFacultyHelpQuestion();
//     }
...
//             </ul>
//         `;
//         facultyContacts.style.display = 'block';
//     }
...
//                 <p>Do you want to identify weak subjects?</p>
...
//             document.getElementById("weakSubjectSection").style.display = 'block';
//             questionContainer.style.display = 'none';
//         });

//         document.getElementById("noBtn").addEventListener("click", () => {
//             questionContainer.style.display = 'none';
//             if (weakSubjects.length > 0) askFacultyHelpQuestion();
//         });
//     }
